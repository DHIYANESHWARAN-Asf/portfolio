...
import { ArrowRight, Mail, Code2, Cpu, Terminal, Sparkles, RotateCcw, Compass } from 'lucide-react';
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              ...
              <a
                ...
                className="p-3.5 bg-[#101216] hover:bg-zinc-800 text-zinc-400 hover:text-white border border-zinc-800 hover:border-blue-500/50 rounded-xl transition-all duration-200 hover:scale-[1.05]"
              ...
              <a
                ...
                className="p-3.5 bg-[#101216] hover:bg-zinc-800 text-zinc-400 hover:text-blue-400 border border-zinc-800 hover:border-blue-500/50 rounded-xl transition-all duration-200 hover:scale-[1.05]"
